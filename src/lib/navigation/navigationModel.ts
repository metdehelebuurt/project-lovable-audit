...
function adminNav(rol: AppRole): NavigatieGroep[] {
  ...
  return [
    ...
    { id: "catalogus", label: "Catalogus & data", items: [ITEMS.producten, ITEMS.assemblages, ITEMS.documenten, ITEMS.analytics] },
...
function partnerStaffNav(): NavigatieGroep[] {
  return [
    ...
    { id: "catalogus", label: "Catalogus", items: [ITEMS.producten, ITEMS.assemblages, ITEMS.documenten] },
    { id: "service", label: "Service", items: [ITEMS.helpdesk, ITEMS.kennisbank] },
    { id: "support", label: "Support", items: [ITEMS.feedback, ITEMS.functieverzoek] },
    { id: "systeem", label: "Systeem", items: [ITEMS.instellingen] },
  ];
...
function adviseurNav(): NavigatieGroep[] {
  return [
    ...
    { id: "catalogus", label: "Catalogus & tools", items: [ITEMS.producten, ITEMS.assemblages, ITEMS.tools, ITEMS.documenten] },
    { id: "service", label: "Service", items: [ITEMS.helpdesk, ITEMS.kennisbank] },
    { id: "support", label: "Support", items: [ITEMS.feedback, ITEMS.functieverzoek] },
    { id: "systeem", label: "Systeem", items: [ITEMS.instellingen] },
  ];
