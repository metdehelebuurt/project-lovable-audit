...
export const S07 = () => (
    <section id="s-functies" className="mh-secpad" style={{ padding: "96px 0px", background: "var(--surface-tint)" }}>
      <div className="mh-container">
        <div className="mh-reveal mh-hidden" style={{ maxWidth: "640px", margin: "0px auto 56px", textAlign: "center" }}>
          <div
        ...
        >
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Voor zon-PV, warmtepompen, thuisbatterijen, laadinfrastructuur en isolatie. Door ons onderhouden als normen wijzigen."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Zet pijlen en notities op de foto, direct gekoppeld aan het onderdeel."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Geen bereik in de kruipruimte? De app slaat op en synct later vanzelf."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Dakvlak, hellingshoek, warmteverlies en Rd-waarde gaan mee de calculatie in."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Het formulier laat je niet afronden met gaten in het dossier."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Alles wat je ooit op dat adres deed, blijft vindbaar bij elkaar."}
              </span>
            </p>
          </div>
        </div>
