      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"in plaats van een tweede rit voor ontbrekende gegevens"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"vakgebieden met eigen sjablonen, door ons onderhouden"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"gaten in het dossier bij afronden"}
                  </span>
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"De monteur krijgt precies de velden die bij het werk horen. Er ontbreekt niets meer als de offerte gemaakt moet worden."}
              </span>
            </p>
