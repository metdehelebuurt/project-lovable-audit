          ...
          <div className="mh-reveal" style={{ transitionDelay: "0ms" }}>
            ...
            <h2 style={{ margin: "0px 0px 22px", maxWidth: "26ch" }}>
              <span className="sc-interp">
                {"Waarom de schouw de rest van je project bepaalt"}
              </span>
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "68ch" }}>
              ...
              >
                <span className="sc-interp">
                  {"Elke fout in een installatieproject is te herleiden naar de schouw. Een ontbrekende maat, een niet gefotografeerde meterkast, een vergeten aansluitwaarde: het kost je een tweede rit, een aangepaste offerte of een discussie op de dag van installatie. En dat terwijl de monteur op dat moment gewoon voor de situatie stond en het had kunnen zien."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17.5px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"Het probleem is bijna nooit vakmanschap. Het is dat iedereen anders schouwt. De \u00e9\u00e9n noteert de kabelroute, de ander schrijft \u201cmeterkast ok\u201d en een derde onthoudt het gewoon. Zodra die informatie op kantoor moet landen, moet er iemand bellen. Bij \u00e9\u00e9n project is dat te overzien; bij vijftien per week is het een dagtaak."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17.5px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"Een branchespecifiek schouwformulier lost dat op door de vraag te stellen in plaats van erop te vertrouwen. Zon-PV vraagt om dakvlakken, hellingshoek en schaduw. Een warmtepomp om warmteverlies per vertrek en de opstelplaats van de buitenunit. Isolatie om oppervlakten, bestaande constructie en vocht. Zet je die velden verplicht, dan kan het dossier niet half af raken."}
                </span>
              </p>
            </div>
            <div
            ...
            >
              <figure style={{ margin: "0px" }}>
                <img src="/__l5e/assets-v1/c391fed2-f629-464f-a11c-11dfb72fd591/img02.jpg" alt="Zonnepanelen op een schuin dak, klaar voor opname in de schouw" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", objectFit: "cover", borderRadius: "16px", display: "block" }} />
                <figcaption style={{ marginTop: "9px", fontSize: "13px", color: "var(--text-muted)", lineHeight: "1.45" }}>
                  <span className="sc-interp">
                    {"Zonnepanelen op een schuin dak, klaar voor opname in de schouw"}
                  </span>
                </figcaption>
              </figure>
              <figure style={{ margin: "0px" }}>
                <img src="/__l5e/assets-v1/0833c52a-0480-40d1-b3c1-f09ca797bc60/img30.jpg" alt="Technisch specialist beoordeelt de opname tijdens de schouw" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", objectFit: "cover", borderRadius: "16px", display: "block" }} />
                <figcaption style={{ marginTop: "9px", fontSize: "13px", color: "var(--text-muted)", lineHeight: "1.45" }}>
                  <span className="sc-interp">
                    {"Technisch specialist beoordeelt de opname tijdens de schouw"}
                  </span>
                </figcaption>
              </figure>
            </div>
