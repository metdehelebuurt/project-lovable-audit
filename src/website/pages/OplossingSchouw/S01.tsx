        ...
        >
          <div>
            ...
            <h1 style={{ fontSize: "50px", lineHeight: "1.08", margin: "0px 0px 18px" }}>
              <span className="sc-interp">
                {"In \u00e9\u00e9n bezoek alles goed vastgelegd, volgens de norm"}
              </span>
            </h1>
            <p
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "30px" }}>
              ...
              >
                ...
                <span className="sc-interp">
                  {"Formulier per branche, met de juiste velden"}
                </span>
              </span>
              <span
                style={{ display: "flex", gap: "11px", alignItems: "flex-start", fontSize: "16px", color: "var(--text-heading)", fontWeight: "500" }}
              >
                ...
                <span className="sc-interp">
                  {"Foto\u2019s, metingen en handtekening op locatie"}
                </span>
              </span>
              <span
                style={{ display: "flex", gap: "11px", alignItems: "flex-start", fontSize: "16px", color: "var(--text-heading)", fontWeight: "500" }}
              >
                ...
                <span className="sc-interp">
                  {"Werkt offline, synct zodra je bereik hebt"}
                </span>
              </span>
            </div>
