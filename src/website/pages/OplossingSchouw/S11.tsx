...
export const S11 = () => (
    <section className="mh-secpad" style={{ padding: "80px 0px", background: "var(--surface-tint)" }}>
      <div className="mh-container">
        <div className="mh-reveal mh-hidden" style={{ maxWidth: "640px", marginBottom: "32px" }}>
          <div
        ...
        <div className="mh-reveal mh-hidden" style={{ display: "flex", justifyContent: "center", marginTop: "28px" }}>
