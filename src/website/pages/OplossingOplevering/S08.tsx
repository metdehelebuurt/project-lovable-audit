      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"ondertekend, niet achteraf op kantoor"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"een eigen document volgens de norm"}
                  </span>
                </span>
              </div>
              <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Het dossier is af als de monteur wegrijdt. Bij vragen achteraf hebben we binnen een minuut het bewijs."}
              </span>
            </p>
