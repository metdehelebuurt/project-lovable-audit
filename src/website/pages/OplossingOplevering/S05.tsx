        ...
        >
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"De checklist van de branche is doorlopen en alle bewijsfoto\u2019s staan erin."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Metingen, serienummers, stringplan of inregelrapport worden automatisch ingevuld."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Monteur en klant tekenen op de tablet. Beide partijen krijgen hetzelfde document."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Voorzien van tijdstempel en hash, altijd terug te vinden per adres."}
              </span>
            </p>
          </div>
        </div>
