            ...
            <div className="sc-host-x" style={{ display: "contents" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                >
                  ...
                  >
                    {"Rekent het systeem de Rc-verbetering door?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja. Op basis van de bestaande constructie en de gekozen maatregel wordt de verbetering per bouwdeel berekend en in de offerte onderbouwd."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Krijg ik de subsidie-onderbouwing automatisch?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"De vereiste waarden, oppervlakten en bewijsstukken komen als bijlage bij de offerte en het opleverdocument, zodat de aanvraag compleet is."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Hoe leg ik foto\u2019s v\u00f3\u00f3r en n\u00e1 vast?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"De monteur maakt ze in de app bij het juiste bouwdeel. Ze komen automatisch op de goede plek in het opleverdocument terecht."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Kan ik meerdere maatregelen in \u00e9\u00e9n offerte zetten?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja, bijvoorbeeld vloer, spouw en dak in \u00e9\u00e9n document, elk met eigen oppervlakte, Rc-verbetering en subsidiebedrag."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Wat als de subsidievoorwaarden wijzigen?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Wij werken de bedragen en eisen bij in de subsidiemodule. Nieuwe offertes gebruiken automatisch de actuele situatie."}
                    </div>
                  </div>
                </div>
              </div>
