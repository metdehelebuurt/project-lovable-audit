        ...
        >
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Aanvraag met woningtype en bouwjaar staat direct bij de juiste adviseur."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Vlakken en oppervlaktes opnemen met foto\u2019s v\u00f3\u00f3r de uitvoering, per maatregel."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Rd-waarden en subsidiebedragen automatisch in de offerte; meerdere maatregelen in \u00e9\u00e9n voorstel."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Materiaalstaat berekend uit de opname; ploeg en dagdelen staan in de planning."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Opleverbewijs met foto\u2019s n\u00e1 en subsidiebijlage, klaar om in te dienen."}
              </span>
            </p>
          </div>
        </div>
