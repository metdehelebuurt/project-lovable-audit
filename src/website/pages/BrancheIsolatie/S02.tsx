        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Oppervlaktes drie keer overtypen"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Van meetbriefje naar rekenblad naar offerte, en de laatste versie klopt nooit helemaal."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Subsidie-onderbouwing kost een middag"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Rd-waardes, foto\u2019s v\u00f3\u00f3r en n\u00e1 en bonnen: los verzamelen kost meer tijd dan de klus."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Vijf maatregelen, vijf losse trajecten"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Vloer, spouw, dak en glas in \u00e9\u00e9n woning, maar niet in \u00e9\u00e9n dossier."}
                </span>
              </p>
            </div>
          </div>
