        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Cijfers pas achteraf"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Je weet aan het eind van het kwartaal of een projecttype geld kostte in plaats van opleverde."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Rekenbladen die uiteenlopen"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Verkoop, planning en boekhouding hebben elk hun eigen waarheid."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Geen zicht op bezetting"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Je weet niet of je een monteur erbij moet, of juist verkoopcapaciteit."}
                </span>
              </p>
            </div>
          </div>
