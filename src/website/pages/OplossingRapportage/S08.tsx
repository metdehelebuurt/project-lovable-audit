      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"marge per project, niet pas achteraf"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"voor verkoop, planning en boekhouding"}
                  </span>
                </span>
              </div>
              <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Ik stuur nu op cijfers in plaats van op gevoel. Ik zie meteen welke projecten echt geld opleveren."}
              </span>
            </p>
