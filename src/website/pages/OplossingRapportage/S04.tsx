          ...
          <div className="mh-reveal" style={{ transitionDelay: "0ms" }}>
            ...
            <h2 style={{ margin: "0px 0px 22px", maxWidth: "26ch" }}>
              <span className="sc-interp">
                {"Waarom je marge nu pas achteraf blijkt"}
              </span>
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "68ch" }}>
              ...
              >
                <span className="sc-interp">
                  {"De meeste installatiebedrijven weten aan het eind van het kwartaal of een projecttype geld heeft opgeleverd. Op dat moment zijn de projecten allang afgerond en kun je er niets meer aan doen. Het bekende gevolg: je blijft laadpalen verkopen met een marge die eigenlijk te dun is, omdat niemand het op tijd zag."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17.5px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"De oorzaak is bijna nooit onwil, maar versnippering. Verkoop rekent in een spreadsheet, planning houdt uren bij in een ander bestand en de boekhouding werkt met de facturen die uiteindelijk de deur uit gingen. Drie waarheden die je pas met veel handwerk op \u00e9\u00e9n noemer krijgt, en dan is de maand alweer om."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17.5px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"Wanneer uren, materiaal en meerwerk in dezelfde flow geboekt worden waarin het werk gebeurt, ontstaat de rapportage als bijproduct. Je ziet per project het verschil tussen calculatie en werkelijkheid terwijl het project nog loopt, en dus op het moment dat bijsturen nog iets oplevert."}
                </span>
              </p>
            </div>
            <div
            ...
            >
              <figure style={{ margin: "0px" }}>
                <img src="/__l5e/assets-v1/cda99155-5081-40e3-bacb-4d603c527f2a/img29.jpg" alt="Live cijfers over marge en doorlooptijd in het dashboard" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", objectFit: "cover", borderRadius: "16px", display: "block" }} />
                <figcaption style={{ marginTop: "9px", fontSize: "13px", color: "var(--text-muted)", lineHeight: "1.45" }}>
                  <span className="sc-interp">
                    {"Live cijfers over marge en doorlooptijd in het dashboard"}
                  </span>
                </figcaption>
              </figure>
              <figure style={{ margin: "0px" }}>
                <img src="/__l5e/assets-v1/1c3ef6b4-01d4-4a2e-85f8-e3a0f5d600e0/img39.jpg" alt="Directie en kantoor bespreken de cijfers van deze maand" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", objectFit: "cover", borderRadius: "16px", display: "block" }} />
                <figcaption style={{ marginTop: "9px", fontSize: "13px", color: "var(--text-muted)", lineHeight: "1.45" }}>
                  <span className="sc-interp">
                    {"Directie en kantoor bespreken de cijfers van deze maand"}
                  </span>
                </figcaption>
              </figure>
            </div>
