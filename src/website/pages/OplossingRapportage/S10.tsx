        ...
        >
          <div className="mh-reveal">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              >
                <img src="/__l5e/assets-v1/ce7d2dbc-5b5a-4bf8-b24d-774048ad16a9/img17.jpg" alt="In vijf minuten een offerte die de klant meteen tekent" loading="lazy" style={{ width: "140px", height: "100%", minHeight: "120px", objectFit: "cover", flex: "0 0 140px", display: "block" }} />
              ...
              <a
                ...
                style={{ display: "flex", gap: "0px", alignItems: "stretch", borderRadius: "16px", overflow: "hidden", background: "var(--surface-page)", border: "1px solid var(--border-subtle)", color: "var(--text-heading)" }}
              >
                <img src="/__l5e/assets-v1/8302ba8f-4fec-43d2-9f6f-d1ff185f8b10/img26.jpg" alt="Overstappen naar mijnhuis.nu in drie weken" loading="lazy" style={{ width: "140px", height: "100%", minHeight: "120px", objectFit: "cover", flex: "0 0 140px", display: "block" }} />
                <span style={{ flex: "1 1 0%", padding: "20px 24px", display: "flex", flexDirection: "column", gap: "8px" }}>
                  <span
                    style={{ fontFamily: "\"IBM Plex Mono\", ui-monospace, SFMono-Regular, Menlo, monospace", fontSize: "11px", letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--indigo-600)" }}
                  >
