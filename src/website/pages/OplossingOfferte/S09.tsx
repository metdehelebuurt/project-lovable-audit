            ...
            <div className="sc-host-x" style={{ display: "contents" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                >
                  ...
                  >
                    {"Hoe lang duurt het maken van een offerte echt?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Met de schouwgegevens erin is vijf minuten realistisch voor een standaardproject. De tijd zit in het kiezen van het pakket en het nalezen, niet in het rekenwerk."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Kan ik mijn eigen prijzen en marges gebruiken?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja. Je richt je eigen assortiment in met inkoopprijzen, staffels en marge per regel. Wijzig je een prijs, dan geldt die meteen voor elke nieuwe offerte."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Staat het subsidiebedrag automatisch in de offerte?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja, met de onderbouwing als bijlage. Wij houden de bedragen en voorwaarden bij, zodat je nooit met verouderde cijfers rekent."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Ziet de offerte eruit als mijn eigen bedrijf?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Logo, kleuren, voorwaarden en indeling zijn van jou. Elke adviseur verstuurt hetzelfde document, dus je uitstraling is niet meer afhankelijk van wie het maakt."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja. De ondertekening wordt vastgelegd met naam, datum en tijdstip, en blijft onveranderbaar aan het dossier gekoppeld."}
                    </div>
                  </div>
                </div>
              </div>
