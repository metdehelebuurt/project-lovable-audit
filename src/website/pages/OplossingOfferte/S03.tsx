        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Offertes zijn een flessenhals"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Alles loopt via de eigenaar of \u00e9\u00e9n calculator. Staat die op een dak, dan ligt de verkoop stil."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Excel en Word met fouten"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Verouderde prijzen, verkeerde subsidiebedragen en een pdf die er per adviseur anders uitziet."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Dagen tussen bezoek en offerte"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Hoe langer de klant wacht, hoe kleiner de kans dat hij bij jou tekent."}
                </span>
              </p>
            </div>
          </div>
