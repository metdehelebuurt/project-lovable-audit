    ...
    >
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Zelf sjablonen bouwen per branche"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Schouw, offerte en oplevering staan kant-en-klaar per branche"}
            </span>
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Rekenwerk in losse tools en Excel"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Opbrengst, warmteverlies en Rd-waarde rekenen mee in de offerte"}
            </span>
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Subsidiebedragen handmatig opzoeken"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Actuele subsidie automatisch in offerte \u00e9n onderbouwing"}
            </span>
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Norm-kennis zit bij \u00e9\u00e9n collega"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"De norm zit in het formulier, vergeten kan niet"}
            </span>
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Opleverrapport in Word, ergens in een map"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Ondertekend opleverdossier per branche, gehasht en herleidbaar"}
            </span>
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ padding: "20px 26px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"Branche erbij? Alles opnieuw inrichten"}
            </span>
          </span>
        </div>
        <div
        ...
        >
          ...
          <span style={{ fontSize: "15.5px", color: "var(--text-heading)", fontWeight: "500", lineHeight: "1.5" }}>
            <span className="sc-interp">
              {"De hele verduurzamingsbranche in \u00e9\u00e9n platform, wij houden de normen bij"}
            </span>
          </span>
        </div>
      </div>
