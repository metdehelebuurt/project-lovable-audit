      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"voor een complete weekplanning"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"zichtbaar bij de monteur na een wijziging"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"losse appjes over wie waar moet zijn"}
                  </span>
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Ik plan \u2019s ochtends de week en de mannen zien het meteen. Dat scheelt een berg telefoontjes."}
              </span>
            </p>
