        ...
        >
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Getekende offerte wordt project"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Het project verschijnt met alle schouwgegevens en materialen in de werkvoorbereiding."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Inplannen op de kalender"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Sleep naar een dag en een monteur. Reistijd en beschikbaarheid rekenen mee."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Adres, contact, taken, checklists en documenten staan op de telefoon."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Wijzigen zonder telefoontjes"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Verschuift er iets, dan ziet de monteur dat direct in zijn dag."}
              </span>
            </p>
          </div>
        </div>
