        ...
        <div style={{ maxWidth: "640px", marginBottom: "36px" }}>
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            <span className="sc-interp">
              {"Herken je dit bij warmtepompen?"}
            </span>
          </h2>
        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Warmteverlies in een los rekenblad"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Elke adviseur heeft zijn eigen versie, en de onderbouwing raakt kwijt bij discussie."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Subsidiebedragen kloppen net niet"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Een offerte met een verouderd subsidiebedrag kost je de deal, of je marge."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"F-gassen en inregelen op papier"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Het logboek ligt in de bus, het inregelrapport nog in iemands hoofd."}
                </span>
              </p>
            </div>
          </div>
