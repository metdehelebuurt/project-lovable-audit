      ...
      <div className="mh-container" style={{ position: "relative", padding: "40px 24px 0px" }}>
        ...
        >
          ...
          <div style={{ position: "relative" }}>
              ...
              <div style={{ padding: "20px 22px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "18px" }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: "12.5px", color: "var(--text-body)", lineHeight: "1.4" }}>
                      <span className="sc-interp">
                        {"Bestaande afgifte, isolatie en meterkast in beeld"}
                      </span>
                    </span>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <span style={{ fontSize: "12.5px", color: "var(--text-body)", lineHeight: "1.4" }}>
                      <span className="sc-interp">
                        {"Locatie binnen- en buitenunit met foto\u2019s"}
                      </span>
                    </span>
                  </div>
                </div>
            ...
            >
              <img src="/__l5e/assets-v1/403abba2-0863-45ef-a98c-4ebc30e5b535/img23.jpg" alt="" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", display: "block", objectFit: "cover", borderRadius: "12px" }} />
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"minder terugkomritten door complete voorbereiding"}
              </span>
            </div>
          </div>
          <div>
