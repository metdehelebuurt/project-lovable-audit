        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Elke week dezelfde vragen die kantoortijd kosten en niets opleveren."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Klanten vinden hun offerte, factuur of garantiebewijs niet meer terug."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Stil na de oplevering"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Geen contactmoment meer, dus ook geen vervolgopdracht of verwijzing."}
                </span>
              </p>
            </div>
          </div>
