        ...
        >
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Klant krijgt toegang"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Automatisch bij het tekenen van de offerte, met een eigen inlog."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Meekijken tijdens het traject"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Planning, monteur en documenten. Alles wat jij deelt, ziet hij daar."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Oplevering en facturen"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Het ondertekende dossier en de facturen staan er meteen in."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <h3 style={{ fontSize: "19px", margin: "0px 0px 8px", lineHeight: "1.25" }}>
              <span className="sc-interp">
                {"Daarna: opbrengst en service"}
              </span>
            </h3>
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Monitoring, onderhoud en een servicemelding in twee klikken."}
              </span>
            </p>
          </div>
        </div>
