            ...
            <div className="sc-host-x" style={{ display: "contents" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                >
                  ...
                  >
                    {"Staat het portaal op mijn eigen domein?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Vanaf Professional kan het portaal op je eigen domein staan, met jouw logo en kleuren. De klant blijft daarmee volledig in jouw merk."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Bepaal ik zelf wat de klant ziet?"}
                    <span
                      aria-hidden="true"
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Ja. Je deelt per project welke documenten en statussen zichtbaar zijn. Interne notities en calculaties blijven altijd intern."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Werkt monitoring voor elke installatie?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Bij zon-PV en thuisbatterijen laat het portaal opbrengst en besparing zien via de koppeling met de omvormer of het batterijsysteem."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", padding: "20px 24px", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-display)", fontWeight: "var(--fw-semibold)", fontSize: "18px", color: "var(--text-heading)" }}
                  >
                    {"Hoe komt een servicemelding bij mij terecht?"}
                    <span
                      aria-hidden="true"
                      style={{ flex: "0 0 auto", display: "inline-flex", color: "var(--color-primary)", transition: "transform var(--dur-base) var(--ease-standard)", transform: "none" }}
                    >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"De klant meldt in twee klikken. Er ontstaat een ticket in jouw planning, met de historie van dat adres eraan gekoppeld."}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  >
                    <div style={{ padding: "0px 24px 22px", fontSize: "16px", lineHeight: "1.6", color: "var(--text-body)" }}>
                      {"Nee, het zit in elk plan. Alleen het eigen domein en de volledige white-label zijn aan een hoger plan gebonden."}
                    </div>
                  </div>
                </div>
              </div>
