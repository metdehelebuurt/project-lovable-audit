        ...
        >
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"De monteur opent de app en ziet zijn ritten, adressen en contactpersonen."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Taken en checklists afvinken, foto\u2019s maken, uren en materiaal boeken."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Op locatie ondertekenen. De klant krijgt het document direct per mail."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Zodra er bereik is, staat alles op kantoor. Niemand hoeft iets over te typen."}
              </span>
            </p>
          </div>
        </div>
