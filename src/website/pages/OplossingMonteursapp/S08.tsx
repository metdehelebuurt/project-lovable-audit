      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"volledig bruikbaar zonder bereik"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"om een monteur op weg te helpen"}
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"papieren bonnen die je nog overtypt"}
                  </span>
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"De mannen hoefden er geen cursus voor. Ze pakten het op in een ochtend en willen niet meer terug naar papier."}
              </span>
            </p>
