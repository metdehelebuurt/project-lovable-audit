      ...
      <div className="mh-container">
        ...
        >
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Invullen, fotograferen en tekenen zonder verbinding."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Automatisch aan het juiste onderdeel en dossier gekoppeld."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Geboekt op het project, dus je marge klopt met de werkelijkheid."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Meerwerk of een probleem? Kantoor ziet het meteen bij het project."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Documenten en normen van dit project, in de app doorzoekbaar."}
              </span>
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Gemaakt voor werkhandschoenen, niet voor kantoorpersoneel."}
              </span>
            </p>
          </div>
        </div>
