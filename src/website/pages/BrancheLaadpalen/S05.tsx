            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Aansluitwaarde en groepenkast beoordeeld"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Kabeltrac\u00e9 en montageplek met foto\u2019s"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Load balancing en MID-meting ingepland"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Laadpaal, kabel en installatie gespecificeerd"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Installatie- en meetrapport (MID)"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Configuratie en toegang vastgelegd"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
