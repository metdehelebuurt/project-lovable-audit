        ...
        <div className="mh-reveal" style={{ maxWidth: "660px", marginBottom: "36px" }}>
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            <span className="sc-interp">
              {"De normen rond laadinfrastructuur"}
            </span>
          </h2>
        ...
        >
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"De installatie-eisen voor de groepenkast, aardlekbeveiliging en de aansluiting van het laadpunt."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"De norm voor geleide laadsystemen: laadmodi, communicatie en veiligheid van het laadpunt."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"Voor meetinrichtingen die gebruikt worden om te factureren, bijvoorbeeld bij zakelijk laden of een VvE."}
                </span>
              </p>
            </div>
          </div>
