      ...
      <div className="mh-container" style={{ position: "relative", padding: "40px 24px 0px" }}>
        ...
        >
          <div>
            ...
            >
              <span className="sc-interp">
                {"MID-metering, installatie en oplevering in \u00e9\u00e9n dossier."}
              </span>
            </p>
            <p
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <img src="/__l5e/assets-v1/24c8bf1a-df2a-49f4-9ec0-451b1d8ea4e3/img08.jpg" alt="" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", display: "block", objectFit: "cover", borderRadius: "12px" }} />
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"minder administratietijd per laadpunt"}
              </span>
            </div>
          </div>
          <div>
