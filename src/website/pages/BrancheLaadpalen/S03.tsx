...
export const S03 = () => (
    <section className="mh-secpad" style={{ padding: "88px 0px", background: "var(--surface-page)" }}>
      <div className="mh-container">
        <div className="mh-reveal" style={{ maxWidth: "660px", marginBottom: "16px", transitionDelay: "0ms" }}>
          <div
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            ...
            {"-project bij jou straks"}
          </h2>
          <p style={{ fontSize: "17px", color: "var(--text-body)", margin: "0px", lineHeight: "1.6" }}>
            {"E\u00e9n doorlopende lijn, vijf stappen, geen enkele keer overtypen."}
          </p>
        </div>
        <div className="mh-reveal" style={{ margin: "26px 0px -2px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              <path d="M0 40 L1000 40" fill="none" stroke="var(--dossier-line)" strokeWidth="var(--dossier-line-width)" strokeLinecap="round" strokeDasharray="6 8" style={{ strokeDasharray: "1000", strokeDashoffset: "0", transition: "stroke-dashoffset 1200ms var(--ease-standard)" }} />
              <g>
        ...
        >
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Zakelijke en particuliere aanvragen komen in dezelfde pijplijn, direct gekwalificeerd."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Meterkast, groepen en kabelroute in beeld; load balancing meteen gecheckt."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Vaste pakketprijzen per situatie, offerte de deur uit terwijl je nog op de oprit staat."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Klussen gebundeld per wijk; de monteur ziet route, materiaal en klantcontact op zijn telefoon."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Installatieverklaring, serienummer en laadpuntregistratie in \u00e9\u00e9n ondertekend dossier."}
              </span>
            </p>
          </div>
        </div>
        <div className="mh-cta mh-reveal" style={{ display: "flex", gap: "14px", flexWrap: "wrap", marginTop: "44px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            <a
              href="/demo"
              className="mh-btn"
