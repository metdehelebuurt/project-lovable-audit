      ...
      <div className="mh-container" style={{ position: "relative", padding: "40px 24px 0px" }}>
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <img src="/__l5e/assets-v1/e82198fd-6f9c-4a2f-802e-9c6a6629ce72/img10.jpg" alt="" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", display: "block", objectFit: "cover", borderRadius: "12px" }} />
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"terugverdientijd op echte verbruiksdata"}
              </span>
            </div>
          </div>
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"compatibiliteit gecheckt, niet op locatie"}
              </span>
            </div>
          </div>
          <div>
