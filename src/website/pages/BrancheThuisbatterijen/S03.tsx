        ...
        >
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Aanvraag komt binnen met verbruiksprofiel en bestaande PV-installatie."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Meterkast, omvormer en opstelplaats geschouwd; compatibiliteit meteen gecheckt."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Terugverdienscenario op basis van \u00e9chte verbruiksdata, met actuele tarieven in de offerte."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Configuratie en materiaal staan klaar; de monteur werkt de checklist op locatie af."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Configuratierapport en veiligheidscheck ondertekend; monitoring loopt door in het portaal."}
              </span>
            </p>
          </div>
        </div>
