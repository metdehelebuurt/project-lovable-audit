        ...
        <div className="mh-reveal" style={{ maxWidth: "660px", marginBottom: "36px" }}>
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            <span className="sc-interp">
              {"De normen rond thuisbatterijen"}
            </span>
          </h2>
        ...
        >
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"De installatie-eisen voor de elektrische aansluiting, beveiliging en scheiding van het batterijsysteem."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"Veiligheidseisen voor lithium-ion cellen en accupakketten in stationaire toepassingen."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "15px", color: "var(--text-body)", lineHeight: "1.6" }}>
                <span className="sc-interp">
                  {"De normreeks voor energieopslagsystemen: opstelling, beveiliging en prestatie."}
                </span>
              </p>
            </div>
          </div>
