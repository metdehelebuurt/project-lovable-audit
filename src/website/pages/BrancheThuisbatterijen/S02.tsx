        ...
        <div style={{ maxWidth: "640px", marginBottom: "36px" }}>
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            <span className="sc-interp">
              {"Herken je dit bij thuisbatterijen?"}
            </span>
          </h2>
        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"De regels veranderen sneller dan je offerte"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Terugleverkosten en saldering schuiven; een sjabloon van vorige maand klopt al niet meer."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Past de batterij bij de bestaande omvormer?"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Zonder vaste compatibiliteitscheck kom je er pas achter als het ding er staat."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Opstelplaats en veiligheid ad hoc"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Brandveiligheid en ventilatie-eisen leven in het hoofd van \u00e9\u00e9n collega."}
                </span>
              </p>
            </div>
          </div>
