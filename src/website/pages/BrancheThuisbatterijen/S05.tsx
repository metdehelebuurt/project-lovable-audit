...
export const S05 = () => (
    <section className="mh-secpad" style={{ padding: "72px 0px", background: "var(--surface-page)" }}>
      <div className="mh-container">
        <div className="mh-reveal" style={{ maxWidth: "620px", marginBottom: "36px" }}>
          <div
            ...
            >
              ...
              >
                ...
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Opstelplaats, brandveiligheid en ventilatie beoordeeld"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Aansluiting op omvormer en meterkast vastgelegd"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Batterijcapaciteit en besparing doorgerekend"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                ...
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Digitaal ondertekend ter plekke"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              >
                ...
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Veiligheids- en isolatiemetingen vastgelegd"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Tweezijdig ondertekend opleverdossier"}
                  </span>
                </li>
              </ul>
            </div>
