          ...
          <div className="mh-reveal mh-hidden">
            ...
            <h2 style={{ margin: "0px 0px 22px", maxWidth: "24ch" }}>
              <span className="sc-interp">
                {"Wat komt er kijken bij een zonnepanelenproject?"}
              </span>
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "68ch" }}>
              ...
              >
                <span className="sc-interp">
                  {"Een zonnepanelenproject begint bij het dak. Ori\u00ebntatie, hellingshoek, dakbedekking en schaduw bepalen samen wat een installatie realistisch opwekt. Wie dat op gevoel inschat, belooft een opbrengst die later niet gehaald wordt, en dat kost vertrouwen \u00e9n geld. In mijnhuis.nu leg je de dakvlakken vast op de tablet en rekent het systeem de verwachte opbrengst en terugverdientijd meteen door."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"Daarna volgt de elektrotechnische kant: de meterkast, het aantal groepen, de kabelroute en de keuze van omvormer en montagesysteem. Die gegevens komen rechtstreeks uit de schouw in je calculatie, zodat de offerte klopt met wat de monteur straks aantreft. De klant ziet in \u00e9\u00e9n document wat er komt, wat het opwekt en wat het kost, inclusief subsidie waar die van toepassing is."}
                </span>
              </p>
              <p
                style={{ margin: "0px", fontSize: "17px", lineHeight: "1.75", color: "var(--text-body)", textWrap: "pretty" }}
              >
                <span className="sc-interp">
                  {"Bij oplevering telt het bewijs. Stringplan, serienummers, meetwaarden en foto\u2019s horen in het dossier, opgesteld volgens de geldende normen. Omdat je monteur dat op locatie afrondt en de klant ter plekke tekent, is het dossier compleet voordat de bus wegrijdt. Bij een latere garantieclaim of controle heb je alles binnen een minuut bij de hand."}
                </span>
              </p>
            </div>
            <div
