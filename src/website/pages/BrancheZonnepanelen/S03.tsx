    ...
    <section className="mh-secpad" style={{ padding: "88px 0px", background: "var(--surface-page)" }}>
      <div className="mh-container">
        ...
        >
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Aanvraag van je website of campagne staat direct in de pijplijn, met adres en dakinfo."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Dakvlakken, hellingshoek en schaduw op de tablet, inclusief foto\u2019s van meterkast en kabelroute."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Opbrengst, terugverdientijd en prijs in \u00e9\u00e9n offerte; de klant tekent digitaal vanaf de bank."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Materiaalstaat en stringplan gaan mee naar de planning; de monteur ziet alles op zijn telefoon."}
              </span>
            </p>
          </div>
          <div>
            ...
            <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Scope 12-checklist, serienummers en foto\u2019s in het dossier; de klant volgt de opbrengst in het portaal."}
              </span>
            </p>
          </div>
        </div>
        <div
          ...
          style={{ display: "flex", gap: "14px", flexWrap: "wrap", marginTop: "44px" }}
        >
          <div className="sc-host-x" style={{ display: "contents" }}>
            <a
              href="/demo"
