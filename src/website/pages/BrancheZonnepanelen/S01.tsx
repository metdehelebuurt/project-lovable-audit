      ...
      <div className="mh-container" style={{ position: "relative", padding: "40px 24px 0px" }}>
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <img src="/__l5e/assets-v1/c391fed2-f629-464f-a11c-11dfb72fd591/img02.jpg" alt="" loading="lazy" style={{ width: "100%", aspectRatio: "4 / 3", display: "block", objectFit: "cover", borderRadius: "12px" }} />
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"schouw \u00e9n offerte in \u00e9\u00e9n afspraak"}
              </span>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.76)", lineHeight: "1.45" }}>
              <span className="sc-interp">
                {"digitaal opgeleverd volgens Scope 12"}
              </span>
            </div>
          </div>
        </div>
