...
export const S05 = () => (
    <section className="mh-secpad" style={{ padding: "72px 0px", background: "var(--surface-page)" }}>
      <div className="mh-container">
        <div className="mh-reveal mh-hidden" style={{ maxWidth: "620px", marginBottom: "36px" }}>
          <div
          ...
          <h2 style={{ margin: "0px 0px 10px" }}>
            {"Wat er precies klaarstaat voor "}
            <span className="sc-interp">
              {"Zonnepanelen"}
            </span>
          </h2>
          <p style={{ fontSize: "17px", color: "var(--text-body)", margin: "0px", lineHeight: "1.6" }}>
            {"De formulieren, berekeningen en documenten die je bij ons uit de doos krijgt."}
          </p>
        </div>
        <div
          ...
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
                ...
                <h3 style={{ fontSize: "19px", margin: "0px" }}>
                  {"Schouw"}
                </h3>
              </div>
              <ul
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="sc-interp">
                    {"Dakvlakken, ori\u00ebntatie en hellingshoek op de tablet"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"PVGIS-opbrengst en schaduwanalyse direct doorgerekend"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Dakconstructie, meterkast en kabelroute met foto\u2019s"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Staffelprijzen per paneel, omvormer en montagesysteem"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Opbrengst en terugverdientijd automatisch in de offerte"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Subsidie waar van toepassing, digitaal ondertekend"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              >
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  ...
                  <span className="sc-interp">
                    {"Oplevering met SCIOS Scope 12-checklist"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Stringplan, serienummers en foto\u2019s in het dossier"}
                  </span>
                </li>
                <li style={{ display: "flex", gap: "10px", fontSize: "14.5px", color: "var(--text-body)", lineHeight: "1.5" }}>
                  <svg
                  ...
                  <span className="sc-interp">
                    {"Tweezijdig ondertekend opleverrapport met tijdstempel"}
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div
          ...
          style={{ marginTop: "20px", borderRadius: "14px", border: "1px solid var(--border-subtle)", background: "var(--surface-tint)", padding: "24px 28px", display: "flex", gap: "24px", alignItems: "center", flexWrap: "wrap" }}
        >
          <div style={{ flex: "1 1 0%", minWidth: "240px" }}>
            <div
              style={{ fontFamily: "var(--font-body)", fontWeight: "600", fontSize: "12px", letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--indigo-600)", marginBottom: "10px" }}
            >
              {"Volgens de norm"}
            </div>
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              <span
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "99px", background: "rgb(255, 255, 255)", border: "1px solid var(--border-subtle)", fontSize: "14px", fontWeight: "600", color: "var(--text-heading)", whiteSpace: "nowrap" }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
