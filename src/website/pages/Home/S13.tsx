  ...
  <BillingProvider>
    <section className="mh-secpad" style={{ padding: "96px 0px", background: "var(--surface-page)" }}>
      <div className="mh-container">
        <div className="mh-reveal" style={{ textAlign: "center", maxWidth: "640px", margin: "0px auto 32px" }}>
          <div
        ...
        <div
          ...
          style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px", alignItems: "start", marginTop: "24px" }}
        >
          <div
        ...
        <p
          className="mh-reveal"
          style={{ textAlign: "center", fontSize: "15px", color: "var(--text-muted)", marginTop: "28px" }}
        >
          {"In elk plan: onbeperkte projecten, Nederlandse support, data in de EU, en begeleide onboarding. Maandelijks opzegbaar."}
        </p>
        <p className="mh-reveal" style={{ textAlign: "center", fontSize: "15px", marginTop: "6px" }}>
          {"Twijfel je welk plan past? "}
          <a href="/demo" style={{ fontWeight: "600" }}>
            {"Plan een demo"}
          </a>
          {", dan rekenen we het samen uit."}
        </p>
      </div>
    </section>
  </BillingProvider>
