      ...
      <div className="mh-container">
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "15.5px", color: "var(--neutral-600)", lineHeight: "1.5" }}>
                  <span className="sc-interp">
                    {"van websiteformulier naar toegewezen lead"}
                  </span>
                </span>
              </div>
              <div
          ...
          >
            ...
            >
              <span className="sc-interp">
                {"Aanvragen kwamen binnen in een gedeelde mailbox en bleven soms dagen liggen. Nu valt elke lead direct in de pijplijn en wordt hij dezelfde dag opgevolgd."}
              </span>
            </p>
