        ...
        >
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Van je website, een campagne of telefonisch. Het formulier op je site schrijft direct in de pijplijn."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Op branche, postcode of beschikbaarheid. De adviseur krijgt meteen een melding."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Belafspraken, notities en herinneringen staan bij de lead. Niets meer in je hoofd of op een briefje."}
              </span>
            </p>
          </div>
          <div className="mh-step">
            ...
            <p style={{ margin: "0px", fontSize: "15px", color: "var(--neutral-600)", lineHeight: "1.55" }}>
              <span className="sc-interp">
                {"Groen licht? Dezelfde kaart rolt door naar de schouw, met alle klantgegevens erbij."}
              </span>
            </p>
          </div>
        </div>
