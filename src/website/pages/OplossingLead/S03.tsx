        ...
        <div className="mh-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Aanvragen in een gedeelde mailbox"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Niemand weet wie hem oppakt, dus blijft hij liggen tot de klant al bij de concurrent zit."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Wie als eerste belt, wint. Zonder opvolgtaken is dat te vaak niet jouw bedrijf."}
                </span>
              </p>
            </div>
          </div>
          <div className="sc-host-x" style={{ display: "contents" }}>
            ...
            >
              ...
              >
                <span className="sc-interp">
                  {"Geen zicht op wat er open staat"}
                </span>
              </div>
              <p style={{ margin: "0px", fontSize: "14.5px", color: "var(--text-muted)", lineHeight: "1.55" }}>
                <span className="sc-interp">
                  {"Je weet niet hoeveel offertes lopen, en al helemaal niet waarom deals afvallen."}
                </span>
              </p>
            </div>
          </div>
