...
export const PriceClassic: React.FC<PrijstabelProps> = ({ pc, sc, pcTint2, regels, subtotaal, btwBedrag, totaalBedrag, formatCurrency }) => (
    ...
    <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 16 }}>
      <div style={{ width: 260 }}>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", fontSize: 12, color: "#666" }}>
          <span>Subtotaal excl. BTW</span><span>{formatCurrency(subtotaal)}</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", fontSize: 12, color: "#666" }}>
...
export const PriceModern: React.FC<PrijstabelProps> = ({ pc, sc, pcTint, regels, subtotaal, btwBedrag, totaalBedrag, formatCurrency }) => (
  <div style={{ fontFamily: "'Rubik', sans-serif" }}>
    {regels.map((r, i) => {
      const sub = r.aantal * r.prijs_per_stuk * (1 - r.korting_percentage / 100);
      return (
    ...
    <div style={{ marginTop: 16, padding: "16px 20px", backgroundColor: sc, borderRadius: 12, color: "#fff" }}>
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, opacity: 0.7, marginBottom: 4 }}>
        <span>Subtotaal</span><span>{formatCurrency(subtotaal)}</span>
      </div>
...
export const PriceCompact: React.FC<PrijstabelProps> = ({ pc, sc, regels, subtotaal, btwBedrag, totaalBedrag, formatCurrency }) => (
  <div style={{ fontFamily: "'Rubik', sans-serif" }}>
    {regels.map((r, i) => {
      const sub = r.aantal * r.prijs_per_stuk * (1 - r.korting_percentage / 100);
      return (
...
export const PriceDetailed: React.FC<PrijstabelProps> = ({ pc, sc, pcTint, pcTint2, regels, subtotaal, btwBedrag, totaalBedrag, formatCurrency }) => (
  <div style={{ fontFamily: "'Rubik', sans-serif" }}>
